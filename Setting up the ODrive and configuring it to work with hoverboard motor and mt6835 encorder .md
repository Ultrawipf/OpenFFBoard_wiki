...
3. Put the Odrive into DFU mode and plug it in. (Remove the DFU jumper if you have jumpers otherwise put the dipswitch to the DFU side and power it up)<br><br>
   <img src="img/ODrive Setup Images/OD_DFU_Jumper"  width="897"/>![odrive-s1-dfu-switch](https://github.com/GameRiot6408/OpenFFBoard_wiki/assets/159271841/222cc5c2-7837-40f9-82a2-64bb89e41e15)
